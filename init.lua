...
vim.o.shiftwidth = 4 -- Number of spaces inserted when indenting-  For more options, you can see `:help option-list`
...
vim.keymap.set('n', 'ñ', '@') -- More practical for spanish keyboard
vim.keymap.set('n', 'ñ', '@') -- More practical for spanish keyboard

-- Diagnostic keymaps
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>pd', '[d', { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', '<leader>nd', ']d', { desc = 'Go to next [D]iagnostic message' })
